...
class Aircraft {
    ...
    createAirplaneTextIcon(altitude, speed, colour) {
        const size = 16;
        return L.divIcon({
            html: '<div><span style="font-size: 10px;">GPS</span></div><div style="color: ' + colour + '; font-size: ' + size + 'px">' + this.displayText + '<br/>' + speed.toFixed(0) + 'kn ' + altitude.toFixed(0) + 'ft</div></div>',
            iconAnchor: [100, -10],
            iconSize: [200, size],
