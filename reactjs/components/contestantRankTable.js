...
class ConnectedContestantRankTable extends Component {
    ...
    render() {
        ...
        return <BootstrapTable keyField={"rank"} data={this.buildData()} columns={this.columns}
                               bootstrap4 striped hover condensed pagination={paginationFactory(paginationOptions)}
                               rowEvents={rowEvents}/>
    }
}

const ContestantRankTable = connect(mapStateToProps, {setDisplay, displayOnlyContestantTrack})(ConnectedContestantRankTable)
