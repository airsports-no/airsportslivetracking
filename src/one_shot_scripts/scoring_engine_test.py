...
def compare_results(original, cloned):
    ...
    if original.contestanttrack.score != cloned.contestanttrack.score:
        discrepancies.append(f"Score mismatch: Original={original.contestanttrack.score}, Cloned={cloned.contestanttrack.score}")
            ...
            for task in tasks:
                ...
                for contestant in contestants:
                    ...
                    if discrepancies:
                        ...
                        all_contestants_passed = False
                        # sys.exit(1) # Optionally exit on first failure or continue
