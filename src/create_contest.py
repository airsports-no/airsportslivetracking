...
#                                  start_time=datetime.now(), finish_time=datetime.now() + timedelta(hours=2))
#
...
#     contestant = Contestant.objects.create(contest=contest, team=team, takeoff_time=datetime.now(),
#                                            finished_by_time=datetime.now() + timedelta(hours=2),
