...
from display.utilities.navigation_task_type_definitions import CIMA_PRECISION


def get_default_scorecard():
    scorecard, created = Scorecard.objects.update_or_create(
        name="CIMA Precision 2023",
        defaults={
            "shortcut_name": "CIMA Precision",
            ...
            "task_type": [CIMA_PRECISION],
            "calculator": CIMA_PRECISION,
    ...
    regular_gate_score, created = GateScore.objects.update_or_create(
        ...
        defaults={
            ...
            "included_fields": [
                ["Penalties", "penalty_per_second", "maximum_penalty", "missed_penalty", "hit_bonus"],
