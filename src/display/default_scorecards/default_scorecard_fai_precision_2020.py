...
fai_precision_flying_2020, created = Scorecard.objects.get_or_create(name="FAI Precision 2020", backtracking=200,
...
if created:
    ...
    fai_precision_flying_2020.takeoff_gate_score = GateScore.objects.create(extended_gate_width=0,
                                                                            ...
                                                                            missed_penalty=0,
                                                                            missed_procedure_turn=0)
    fai_precision_flying_2020.landing_gate_score = None
