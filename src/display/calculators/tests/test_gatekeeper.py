...
class TestInterpolation(TransactionTestCase):
    ...
    def test_interpolation(self, p, p2):
        ...
        interpolated = gatekeeper.interpolate_track(next_position)
        expected = [("2020-01-01 00:00:01+00:00", 60.00060459827332, 11.199996353395562),
...
class TestCrossingEstimate(TransactionTestCase):
    ...
    def test_next_is_timed(self, p1, p2):
        ...
        gatekeeper = GatekeeperRoute(self.contestant, [])
        start_position = Position(dateutil.parser.parse("2020-01-01T00:00:00Z"), 59.19144317223039, 9.481523867089488,
                                  0, 70, 270, 0, 0, 0)
        next_position = Position(dateutil.parser.parse("2020-01-01T00:00:02Z"), 59.19144317223039, 9.481623867089488, 0,
                                 70, 270, 0, 0, 0)
