...
class TestCoordinateUtilities(TestCase):
    ...
    @parameterized.expand([
        ...
        (0, 0, 1, 1, 0, 2, 100000, [[1.6370837505800435, 0.9997903743814506],
                                    [0.36316505969385393, 1.00008496112306]]),
    ...
    @parameterized.expand([
        ...
        (0, 0, 1, 1, 2, 0, 100000,
         [[0.9996841346197735, 1.637193664207181],
          [1.0000699719117447, 0.3628038545366372]]),
    ...
    @parameterized.expand([
        ((39.45034771486001,-0.934335433471053),(39.42032520123871,-0.9223165368370068), 3490.1299783482964)
        ])
