...
class TestContestTokenReplacementApi(APITestCase):
    def setUp(self):
        ...
        self.small_type = TokenType.objects.create(name="Replace small", contestant_limit=10, task_limit=1)
        self.large_type = TokenType.objects.create(name="Replace large", contestant_limit=50, task_limit=5)
