...
<ol>
    <li>Maximize the use of the Live Tracking app. Watch our tutorial for useful tips on installing and using the App. <a href="https://home.airsports.no/tutorials/#install"><strong>– Installation tutorial –</strong></a></li>
...
<p>For more info visit our <strong>News & FAQ</strong>: <a href="https://home.airsports.no/">home.airsports.no</a> or see our tutorials on <a href="https://www.youtube.com/c/AirSportsLiveTracking?sub_confirmation=1">YouTube</a>, and please subscribe.</p>
...
<strong>Huawei/OnePlus</strong> : We have experienced that some phones do not provide access to the battery when the app is in the background. Smartphone owners must therefore check, and go into the settings and manually give the APP access to the battery when the app is in the background mode. <a href="https://home.airsports.no/tutorials/#install"><strong>Please watch the installation tutorial for crucial settings and helpful tips!</strong></a></p>
...
<p><strong>HELP – Do not hesitate to contact us</strong> if you have any questions. If there are more who are interested in access (for example to for training) then we can arrange that. We can also do a skype or MS Teams meeting to explain more. Once you have created your first competition, if you want, we can do an overview to see that everything is in order before you make your flight. Just let us know. Please visit <a href="https://home.airsports.no/faq/"><strong>home.airsports.no</strong></a>, here you will find <strong>News, Tutorials, FAQ</strong>, <strong>Webinars</strong> and other <strong>helpful information</strong>.</p>
