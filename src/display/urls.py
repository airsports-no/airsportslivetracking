...
from display.views import (
    ...
    delete_score_item,
    apply_contestant_quarantine_penalty,
...
urlpatterns = [
    ...
    path(
        "contestant/<int:pk>/recalculate_start_time/",
        ContestantRecalculateWithStartTimeView.as_view(),
        name="contestant_recalculate_start_time",
    ),
