# Generated by Django 3.1 on 2021-02-09 10:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracker_device_id', models.CharField(help_text='ID of physical tracking device that will be brought into the plane', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', display.models.CharNullField(blank=True, max_length=60, null=True)),
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None)),
                ('app_tracking_id', display.models.CharNullField(blank=True, max_length=100, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', multiselectfield.db.fields.MultiSelectField(choices=[('precision', 'Precision'), ('anr_corridor', 'ANR corridor')], default=list, max_length=22)),
                ('use_procedure_turns', models.BooleanField(blank=True, default=True)),
        ...
        migrations.AddField(
            model_name='navigationtask',
            name='scorecard',
            field=models.ForeignKey(help_text='Reference to an existing scorecard name. Currently existing scorecards: <function NavigationTask.<lambda> at 0x7f04c3f61730>', on_delete=django.db.models.deletion.PROTECT, to='display.scorecard'),
        ),
        migrations.AddField(
            model_name='navigationtask',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gate_actual_times', display.my_pickled_object_field.MyPickledObjectField(default=dict, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='display.person')),
