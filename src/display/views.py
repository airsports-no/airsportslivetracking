...
@api_view(["GET"])
@permission_required_or_403('display.view_contest', (Contest, "navigationstask__pk", "pk"))
...
@permission_required_or_403('display.change_contest', (Contest, "navigationstask__pk", "pk"))
